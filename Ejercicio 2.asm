...
mensaje3 db 'el mayor de los dos numero es :$'
.code 
main proc 
mov ax ,@data 
mov ds , ax
...
cmp al , bl 
jg mayor ;Saltar a etiqueta "mayor" si al > bl 
;Si no , el primer numero es el mayor 
mov al , bl
mayor:
; Mostrar el numero mayor add al 30h ;Convertir el numero a caracter 
mov ah, 02h
lea dx , mensaje3
int 21h
mov dl ,al 
